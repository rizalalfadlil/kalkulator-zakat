    ...
    <div className="border border-gray-300 rounded-lg p-4">
      ...
      {isChecked && (
        <div className="mt-4 space-y-3 pl-8">
          <div>
            <label className="block text-sm font-medium">Jumlah Kambing/Domba: <span className="text-xs text-gray-500">(Nisab: 40 ekor)</span></label>
            <input
              type="number"
              placeholder="40"
              value={kambing || ''}
          ...
          <div>
            <label className="block text-sm font-medium">Jumlah Sapi/Kerbau: <span className="text-xs text-gray-500">(Nisab: 30 ekor)</span></label>
            <input
              type="number"
              placeholder="30"
              value={sapi || ''}
