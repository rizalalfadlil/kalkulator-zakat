    ...
    <div className="bg-slate-50 rounded p-4">
      <label className="flex items-center space-x-3 cursor-pointer">
        ...
        <span className="text-lg font-bold">
          Uang, Tabungan, Penghasilan, Investasi, Kelautan dan Perniagaan
        </span>
      </label>
      {isChecked && (
        <div className="mt-4 space-y-3 pl-8">
          <p className="text-sm text-gray-600">
            Total nilai dari semua harta ini. Nisabnya setara 85 gram emas (Rp
            197.285.000).
          </p>
          <div>
            <label className="block text-sm font-medium">
              ...
              <span className="text-xs text-gray-500">
                (Gaji setahun, saldo tabungan, nilai investasi, aset perniagaan)
              </span>
            </label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium">
              ...
              <span className="text-xs text-gray-500">
                (Untuk gaji, gunakan total 1 tahun)
              </span>
            </label>
            <input
              type="number"
